!function(e) {
    ...
    e(document).ready((function() {
        setTimeout((function() {
            ...
            e("#loader").hasClass("loaded") && e("#preloader").delay(9e3).queue((function() {
                e(this).remove()
            }
            ))
        }
    ...
    e(".destination-prev").on("click", (function() {
        var t;
        (t = e(".destination-list-area .destination-list-wrap.active")).prev().length > 0 ? (t.removeClass("active"),
        t.prev().addClass("active")) : (t.removeClass("active"),
        e(".destination-list-area .destination-list-wrap:last").addClass("active"))
    }
    )),
    e(".destination-next").on("click", (function() {
        var t;
        (t = e(".destination-list-area .destination-list-wrap.active")).next().length > 0 ? (t.removeClass("active"),
        t.next().addClass("active")) : (t.removeClass("active"),
        e(".destination-list-area .destination-list-wrap:first").addClass("active"))
    }
    )),
    ...
    var l, c, d, u = ".ajax-contact", p = '[name="email"]', h = e(".form-messages");
    function f() {
        var t = e(u).serialize();
        (function() {
            var t, a = !0;
            ...
            e(p).val() && e(p).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(p).removeClass("is-invalid"),
            a = !0) : (e(p).addClass("is-invalid"),
            a = !1);
            return a
        }
        )() && jQuery.ajax({
    ...
    e((function() {
        ...
        e("#loadMore").on("click", (function(t) {
            ...
            0 == e(".loadcontent:hidden").length && e("#loadMore").text("No Content").addClass("noContent")
        }
        ))
    }
    )),
